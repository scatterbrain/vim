...
hi PreProc guifg=#00CC25
hi Type	guifg=#00DD16
hi Special guifg=#EEBABA
hi Ignore	guifg=grey60
hi Todo	guibg=#9C8C84 guifg=#244C0A
hi Label guifg=#ffc0c0

hi FunHead guifg=#769DD5 gui=underline
hi FunArgs guifg=#CCCCCC
hi FunGuard guifg=#BA911F 

hi FunArgAtom guifg=#CCCCCC gui=bold
hi FunArgVar  guifg=#CCCCCC gui=underline
